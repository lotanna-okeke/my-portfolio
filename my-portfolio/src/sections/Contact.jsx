          ...
          >
            <div className="flex flex-col gap-2">
              ...
              <p
                ...
                className="text-gray-400 text-2xl hover:text-[#C8A26B] transition duration-300 cursor-pointer"
              >
                lotannaokeke44@gmail.com
              </p>

              {/* Phone Number - Copies to Clipboard */}
              <p
                onClick={(e) => {
                  copyToClipboard("+2348021698338");
                }}
                className="text-gray-400 text-2xl hover:text-[#C8A26B] transition duration-300 cursor-pointer"
              >
                +2348021698338
